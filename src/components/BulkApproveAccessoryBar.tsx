...
import { bulkApproveAccessory } from "@/lib/accessory-actions";

export default function BulkApproveAccessoryBar({
  selectedIds,
  onDone,
}: {
  selectedIds: string[];
  ...
  const [state, formAction, pending] = useActionState(bulkApproveAccessory, {});
